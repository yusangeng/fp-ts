(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./Alt", "./Alternative", "./Applicative", "./Apply", "./Array", "./Bifunctor", "./BooleanAlgebra", "./Bounded", "./BoundedDistributiveLattice", "./BoundedJoinSemilattice", "./BoundedLattice", "./BoundedMeetSemilattice", "./Category", "./Chain", "./ChainRec", "./Choice", "./Comonad", "./Console", "./Const", "./Contravariant", "./Date", "./DistributiveLattice", "./Either", "./EitherT", "./Exception", "./Extend", "./Field", "./Filterable", "./FilterableWithIndex", "./Foldable", "./Foldable2v", "./FoldableWithIndex", "./Free", "./FreeGroup", "./function", "./Functor", "./FunctorWithIndex", "./Group", "./HeytingAlgebra", "./HKT", "./Identity", "./Invariant", "./IO", "./IOEither", "./IORef", "./IxIO", "./IxMonad", "./JoinSemilattice", "./Lattice", "./MeetSemilattice", "./Monad", "./MonadIO", "./MonadTask", "./Monoid", "./Monoidal", "./NonEmptyArray", "./Option", "./OptionT", "./Ord", "./Ordering", "./Pair", "./Plus", "./Profunctor", "./Random", "./Reader", "./ReaderT", "./ReaderTaskEither", "./Record", "./Ring", "./Semigroup", "./Semigroupoid", "./Semiring", "./Set", "./Setoid", "./State", "./StateT", "./Store", "./StrMap", "./Strong", "./Task", "./TaskEither", "./These", "./Trace", "./Traversable", "./Traversable2v", "./TraversableWithIndex", "./Tree", "./Tuple", "./Unfoldable", "./Validation", "./Writer", "./Compactable", "./Witherable", "./Zipper"], factory);
    }
