 ...
 * @since 1.14.0
 */
export declare const getSetoid: <A>(S: Setoid<A>) => Setoid<NonEmptyArray<A>>;
/**
 ...
 * @since 1.0.0
 */
export declare const nonEmptyArray: Monad1<URI> & Comonad1<URI> & Foldable2v1<URI> & TraversableWithIndex1<URI, number> & FunctorWithIndex1<URI, number> & FoldableWithIndex1<URI, number>;
