 ...
 * @since 1.0.0
 */
export declare function fold<F extends URIS3, U, L>(F: Functor3C<F, U, L>): <R, A>(r: R, some: (a: A) => R, fa: Type3<F, U, L, Option<A>>) => Type3<F, U, L, R>;
export declare function fold<F extends URIS2>(F: Functor2<F>): <L, R, A>(r: R, some: (a: A) => R, fa: Type2<F, L, Option<A>>) => Type2<F, L, R>;
export declare function fold<F extends URIS2, L>(F: Functor2C<F, L>): <R, A>(r: R, some: (a: A) => R, fa: Type2<F, L, Option<A>>) => Type2<F, L, R>;
export declare function fold<F extends URIS>(F: Functor1<F>): <R, A>(r: R, some: (a: A) => R, fa: Type<F, Option<A>>) => Type<F, R>;
