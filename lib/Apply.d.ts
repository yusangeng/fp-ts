...
export interface SequenceT3<F extends URIS3> {
    ...
    <U, L, A, B, C, D>(a: Type3<F, U, L, A>, b: Type3<F, U, L, B>, c: Type3<F, U, L, C>, d: Type3<F, U, L, D>): Type3<F, U, L, [A, B, C, D]>;
    <U, L, A, B, C, D, E>(a: Type3<F, U, L, A>, b: Type3<F, U, L, B>, c: Type3<F, U, L, C>, d: Type3<F, U, L, D>, e: Type3<F, U, L, E>): Type3<F, U, L, [A, B, C, D, E]>;
}
export interface SequenceT3C<F extends URIS3, U, L> {
    ...
    <A, B, C, D>(a: Type3<F, U, L, A>, b: Type3<F, U, L, B>, c: Type3<F, U, L, C>, d: Type3<F, U, L, D>): Type3<F, U, L, [A, B, C, D]>;
    <A, B, C, D, E>(a: Type3<F, U, L, A>, b: Type3<F, U, L, B>, c: Type3<F, U, L, C>, d: Type3<F, U, L, D>, e: Type3<F, U, L, E>): Type3<F, U, L, [A, B, C, D, E]>;
}
export interface SequenceT2<F extends URIS2> {
    ...
    <L, A, B, C, D, E>(a: Type2<F, L, A>, b: Type2<F, L, B>, c: Type2<F, L, C>, d: Type2<F, L, D>, e: Type2<F, L, E>): Type2<F, L, [A, B, C, D, E]>;
}
export interface SequenceT2C<F extends URIS2, L> {
    ...
    <A, B, C, D, E>(a: Type2<F, L, A>, b: Type2<F, L, B>, c: Type2<F, L, C>, d: Type2<F, L, D>, e: Type2<F, L, E>): Type2<F, L, [A, B, C, D, E]>;
}
 ...
 * @since 1.5.0
 */
export declare function sequenceT<F extends URIS3, U, L>(F: Apply3<F>): SequenceT3<F>;
