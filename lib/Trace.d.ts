 ...
 * @since 1.0.0
 */
export declare function traceA<F extends URIS3>(F: Applicative3<F>): <U, L>(message: any) => Type3<F, U, L, void>;
export declare function traceA<F extends URIS3, U, L>(F: Applicative3C<F, U, L>): (message: any) => Type3<F, U, L, void>;
export declare function traceA<F extends URIS2>(F: Applicative2<F>): <L>(message: any) => Type2<F, L, void>;
export declare function traceA<F extends URIS2, L>(F: Applicative2C<F, L>): (message: any) => Type2<F, L, void>;
export declare function traceA<F extends URIS>(F: Applicative1<F>): (message: any) => Type<F, void>;
/**
