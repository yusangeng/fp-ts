 ...
 * @since 1.10.0
 */
export declare function toUnfoldable<F extends URIS>(unfoldable: Unfoldable1<F>): <A>(d: Record<string, A>) => Type<F, [string, A]>;
export declare function toUnfoldable<F>(unfoldable: Unfoldable<F>): <A>(d: Record<string, A>) => HKT<F, [string, A]>;
/**
...
export declare function fromFoldable<F>(F: Foldable<F>): <A>(ta: HKT<F, [string, A]>, f: (existing: A, a: A) => A) => Record<string, A>;
/**
 * @since 1.14.0
 */
 ...
 * @since 1.14.0
 */
export declare function isMember<A>(S: Setoid<A>): (a: A, fa: {
    [key: string]: A;
}) => boolean;
