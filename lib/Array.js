(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./function", "./Option", "./Ord", "./Setoid"], factory);
    }
     ...
     * @since 1.14.0
     */
    exports.isMember = function (S) { return function (a, as) {
    ...
    exports.uniq = function (S) {
        var isMemberS = exports.isMember(S);
        return function (as) {
            var r = [];
            var len = as.length;
            var i = 0;
    ...
    exports.union = function (S) {
        var isMemberS = exports.isMember(S);
        return function (xs, ys) { return function_1.concat(xs, ys.filter(function (a) { return !isMemberS(a, xs); })); };
    };
    /**
    ...
    exports.intersection = function (S) {
        var isMemberS = exports.isMember(S);
        return function (xs, ys) { return xs.filter(function (a) { return isMemberS(a, ys); }); };
    };
    /**
